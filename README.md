...
2. Verify that the install was successful
   <img width="524" height="384" alt="image" src="https://github.com/user-attachments/assets/654ade00-8e15-46fe-9d35-24263afabcb5" />

3. Add the Second Virtual Disk. ( This disk was added through my VM through the settings and now I am configuring it for my Server)
...
14. Run the recovery command in Powershell
